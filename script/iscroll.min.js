(function (h, w) {
    ...
    var f = Math, B = w.createElement("div").style, p = function () {
        ...
        G = /iphone|ipad/gi.test(navigator.appVersion), x = /hp-tablet/gi.test(navigator.appVersion), H = r("perspective") in B, n = "ontouchstart" in h && !x, I = !1 !== p, N = r("transition") in B, E = "onorientationchange" in h ? "orientationchange" : "resize", F = n ? "touchstart" : "mousedown", y = n ? "touchmove" : "mousemove", z = n ? "touchend" : "mouseup", A = n ? "touchcancel" : "mouseup", v = !1 === p ? !1 : {
            ...
            return h.requestAnimationFrame ||
                h.webkitRequestAnimationFrame || h.mozRequestAnimationFrame || h.oRequestAnimationFrame || h.msRequestAnimationFrame || function (b) {
                    return setTimeout(b, 1)
                }
        }(), J = h.cancelRequestAnimationFrame || h.webkitCancelAnimationFrame || h.webkitCancelRequestAnimationFrame || h.mozCancelRequestAnimationFrame || h.oCancelRequestAnimationFrame || h.msCancelRequestAnimationFrame || clearTimeout, s = H ? " translateZ(0)" : "", x = function (b, a) {
            var c = this, d;
            ...
            c.options.zoom && D && (s = "");
            c.scroller.style[K] =
                c.options.useTransform ? k + "transform" : "top left";
    ...
    x.prototype = {
        ...
        _checkDOMChanges: function () {
            this.moved ||
            this.zoomed || this.animating || this.scrollerW == this.scroller.offsetWidth * this.scale && this.scrollerH == this.scroller.offsetHeight * this.scale || this.refresh()
        },
        _scrollbar: function (b) {
            var a;
            this[b + "Scrollbar"] ? (this[b + "ScrollbarWrapper"] || (a = w.createElement("div"), this.options.scrollbarClass ? a.className = this.options.scrollbarClass + b.toUpperCase() : a.style.cssText = "position:absolute;z-index:100;" + ("h" == b ? "height:7px;bottom:1px;left:2px;right:" + (this.vScrollbar ? "7" : "2") + "px" : "width:7px;bottom:" + (this.hScrollbar ?
        ...
        _pos: function (b,
                        a) {
            this.zoomed || (b = this.hScroll ? b : 0, a = this.vScroll ? a : 0, this.options.useTransform ? this.scroller.style[q] = "translate(" + b + "px," + a + "px) scale(" + this.scale + ")" + s : (b = f.round(b), a = f.round(a), this.scroller.style.left = b + "px", this.scroller.style.top = a + "px"), this.x = b, this.y = a, this._scrollbarPos("h"), this._scrollbarPos("v"))
        },
        _scrollbarPos: function (b, a) {
            ...
            8 > c && (c = 8), this[b + "ScrollbarIndicator"].style["h" == b ? "width" : "height"] = c + "px"), c = 0) : c > this[b + "ScrollbarMaxScroll"] && (this.options.fixedScrollbar ? c = this[b + "ScrollbarMaxScroll"] : (c = this[b + "ScrollbarIndicatorSize"] - f.round(3 * (c - this[b + "ScrollbarMaxScroll"])), 8 > c && (c = 8), this[b + "ScrollbarIndicator"].style["h" == b ? "width" : "height"] = c + "px", c = this[b + "ScrollbarMaxScroll"] + (this[b + "ScrollbarIndicatorSize"] - c))), this[b + "ScrollbarWrapper"].style[C] = "0", this[b + "ScrollbarWrapper"].style.opacity = a && this.options.hideScrollbar ?
                "0" : "1", this[b + "ScrollbarIndicator"].style[q] = "translate(" + ("h" == b ? c + "px,0)" : "0," + c + "px)") + s)
        },
        _start: function (b) {
            ...
            this.enabled && (this.options.onBeforeScrollStart && this.options.onBeforeScrollStart.call(this, b), (this.options.useTransition || this.options.zoom) && this._transitionTime(0), this.zoomed = this.animating = this.moved = !1, this.dirY = this.dirX = this.absDistY = this.absDistX = this.distY = this.distX = 0, this.options.zoom && n && 1 < b.touches.length && (d = f.abs(b.touches[0].pageX - b.touches[1].pageX),
                ...
                b), this._bind(y, h), this._bind(z, h), this._bind(A, h))
        },
        _move: function (b) {
            var a = n ? b.touches[0] : b, c = a.pageX - this.pointX, d = a.pageY - this.pointY, e = this.x + c, g = this.y + d, h = b.timeStamp || Date.now();
            this.options.onBeforeScrollMove && this.options.onBeforeScrollMove.call(this, b);
            if (this.options.zoom && n && 1 < b.touches.length)e = f.abs(b.touches[0].pageX - b.touches[1].pageX), g = f.abs(b.touches[0].pageY - b.touches[1].pageY), this.touchesDist = f.sqrt(e * e + g * g), this.zoomed = !0, a = 1 / this.touchesDistStart * this.touchesDist * this.scale,
        ...
        _end: function (b) {
            if (!n || 0 === b.touches.length) {
                var a = this, c = n ? b.changedTouches[0] : b, d, e, g = {dist: 0, time: 0}, l = {
                    dist: 0,
                    time: 0
                ...
                if (a.zoomed)m = a.scale * a.lastScale, m = Math.max(a.options.zoomMin,
                    ...
                    if (a.moved) {
                        if (300 > u && a.options.momentum) {
                            ...
                            l = k ? a._momentum(k - a.startY, u, -a.y, 0 >
                            a.maxScrollY ? a.scrollerH - a.wrapperH + a.y - a.minScrollY : 0, a.options.bounce ? a.wrapperH : 0) : l;
                            m = a.x + g.dist;
                            k = a.y + l.dist;
                            if (0 < a.x && 0 < m || a.x < a.maxScrollX && m < a.maxScrollX)g = {dist: 0, time: 0};
                            if (a.y > a.minScrollY && k > a.minScrollY || a.y < a.maxScrollY && k < a.maxScrollY)l = {
                                dist: 0,
                                time: 0
                            }
                        }
                        g.dist || l.dist ? (g = f.max(f.max(g.time, l.time), 10), a.options.snap && (l = m - a.absStartX, u = k - a.absStartY, f.abs(l) < a.options.snapThreshold && f.abs(u) < a.options.snapThreshold ? a.scrollTo(a.absStartX, a.absStartY, 200) : (l = a._snap(m, k), m = l.x, k = l.y,
                            g = f.max(l.time, g))), a.scrollTo(f.round(m), f.round(k), g)) : a.options.snap ? (l = m - a.absStartX, u = k - a.absStartY, f.abs(l) < a.options.snapThreshold && f.abs(u) < a.options.snapThreshold ? a.scrollTo(a.absStartX, a.absStartY, 200) : (l = a._snap(a.x, a.y), l.x == a.x && l.y == a.y || a.scrollTo(l.x, l.y, l.time))) : a._resetPos(200)
                    } else n && (a.doubleTapTimer && a.options.zoom ? (clearTimeout(a.doubleTapTimer), a.doubleTapTimer = null, a.options.onZoomStart && a.options.onZoomStart.call(a, b), a.zoom(a.pointX, a.pointY, 1 == a.scale ? a.options.doubleTapZoom :
        ...
        _resetPos: function (b) {
            var a = 0 <= this.x ? 0 : this.x < this.maxScrollX ? this.maxScrollX : this.x, c = this.y >= this.minScrollY || 0 < this.maxScrollY ? this.minScrollY : this.y < this.maxScrollY ? this.maxScrollY : this.y;
            a == this.x && c == this.y ? (this.moved && (this.moved = !1, this.options.onScrollEnd && this.options.onScrollEnd.call(this)), this.hScrollbar && this.options.hideScrollbar && ("webkit" == p && (this.hScrollbarWrapper.style[C] = "300ms"), this.hScrollbarWrapper.style.opacity = "0"),
            this.vScrollbar && this.options.hideScrollbar && ("webkit" == p && (this.vScrollbarWrapper.style[C] = "300ms"), this.vScrollbarWrapper.style.opacity = "0")) : this.scrollTo(a, c, b || 0)
        },
        _wheel: function (b) {
            var a = this, c, d;
            if ("wheelDeltaX" in b)c = b.wheelDeltaX / 12, d = b.wheelDeltaY / 12; else if ("wheelDelta" in b)c = d = b.wheelDelta / 12; else if ("detail" in b)c = d = 3 * -b.detail; else return;
            "zoom" == a.options.wheelAction ? (d = a.scale * Math.pow(2, 1 / 3 * (d ? d / Math.abs(d) : 0)), d < a.options.zoomMin && (d = a.options.zoomMin), d > a.options.zoomMax && (d = a.options.zoomMax),
            d != a.scale && (!a.wheelZoomCount && a.options.onZoomStart && a.options.onZoomStart.call(a, b), a.wheelZoomCount++, a.zoom(b.pageX, b.pageY, d, 400), setTimeout(function () {
                a.wheelZoomCount--;
                !a.wheelZoomCount && a.options.onZoomEnd && a.options.onZoomEnd.call(a, b)
            }, 400))) : (c = a.x + c, d = a.y + d, 0 < c ? c = 0 : c < a.maxScrollX && (c = a.maxScrollX), d > a.minScrollY ? d = a.minScrollY : d < a.maxScrollY && (d = a.maxScrollY), 0 > a.maxScrollY && a.scrollTo(c, d, 0))
        },
        ...
        _startAni: function () {
            var b =
                this, a = b.x, c = b.y, d = Date.now(), e, g, h;
            b.animating || (b.steps.length ? (e = b.steps.shift(), e.x == a && e.y == c && (e.time = 0), b.animating = !0, b.moved = !0, b.options.useTransition ? (b._transitionTime(e.time), b._pos(e.x, e.y), b.animating = !1, e.time ? b._bind(v) : b._resetPos(0)) : (h = function () {
                var k = Date.now(), m;
                k >= d + e.time ? (b._pos(e.x, e.y), b.animating = !1, b.options.onAnimationEnd && b.options.onAnimationEnd.call(b), b._startAni()) : (k = (k - d) / e.time - 1, g = f.sqrt(1 - k * k), k = (e.x - a) * g + a, m = (e.y - c) * g + c, b._pos(k, m), b.animating && (b.aniTime =
                    O(h)))
            }, h())) : b._resetPos(400))
        },
        ...
        _momentum: function (b, a, c, d, e) {
            ...
            return {dist: g * (0 > b ? -1 : 1), time: f.round(a / 6E-4)}
        },
        _offset: function (b) {
        ...
        _snap: function (b, a) {
            ...
            c = 0;
            for (d = this.pagesX.length; c < d; c++)if (b >= this.pagesX[c]) {
                e = c;
                break
            }
            ...
            a = this.pagesY[e];
            c = (c = f.abs(a - this.pagesY[this.currPageY])) ?
            f.abs(this.y - a) / c * 500 : 0;
            this.currPageY = e;
            e = f.round(f.max(d, c)) || 200;
            return {x: b, y: a, time: e}
        },
        ...
        refresh: function () {
            ...
            this.scrollerH =
                f.round((this.scroller.offsetHeight + this.minScrollY) * this.scale);
            ...
            this.vScrollbar = this.vScroll && this.options.vScrollbar &&
                this.scrollerH > this.wrapperH;
            b = this._offset(this.wrapper);
            this.wrapperOffsetLeft = -b.left;
            this.wrapperOffsetTop = -b.top;
            if ("string" == typeof this.options.snap)for (this.pagesX = [], this.pagesY = [], c = this.scroller.querySelectorAll(this.options.snap), b = 0, a = c.length; b < a; b++)d = this._offset(c[b]), d.left += this.wrapperOffsetLeft, d.top += this.wrapperOffsetTop, this.pagesX[b] = d.left < this.maxScrollX ? this.maxScrollX : d.left * this.scale, this.pagesY[b] = d.top < this.maxScrollY ? this.maxScrollY : d.top * this.scale; else if (this.options.snap) {
                for (this.pagesX =
                         []; d >= this.maxScrollX;)this.pagesX[a] = d, d -= this.wrapperW, a++;
            ...
            this._scrollbar("h");
            this._scrollbar("v");
            this.zoomed || (this.scroller.style[t] =
        ...
        scrollToElement: function (b, a) {
            var c;
            if (b = b.nodeType ? b : this.scroller.querySelector(b))c = this._offset(b), c.left += this.wrapperOffsetLeft, c.top += this.wrapperOffsetTop, c.left = 0 < c.left ? 0 : c.left < this.maxScrollX ? this.maxScrollX : c.left,
                c.top = c.top > this.minScrollY ? this.minScrollY : c.top < this.maxScrollY ? this.maxScrollY : c.top, a = void 0 === a ? f.max(2 * f.abs(c.left), 2 * f.abs(c.top)) : a, this.scrollTo(c.left, c.top, a)
        },
        scrollToPage: function (b, a, c) {
            c = void 0 === c ? 400 : c;
            this.options.onScrollStart && this.options.onScrollStart.call(this);
            this.options.snap ? (b = "next" == b ? this.currPageX + 1 : "prev" == b ? this.currPageX - 1 : b, a = "next" == a ? this.currPageY + 1 : "prev" == a ? this.currPageY - 1 : a, b = 0 > b ? 0 : b > this.pagesX.length - 1 ? this.pagesX.length - 1 : b, a = 0 > a ? 0 : a > this.pagesY.length -
            1 ? this.pagesY.length - 1 : a, this.currPageX = b, this.currPageY = a, b = this.pagesX[b], a = this.pagesY[a]) : (b *= -this.wrapperW, a *= -this.wrapperH, b < this.maxScrollX && (b = this.maxScrollX), a < this.maxScrollY && (a = this.maxScrollY));
            this.scrollTo(b, a, c)
        },
        disable: function () {
            this.stop();
