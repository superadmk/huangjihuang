...
String.prototype.strip_tags = function (a) {
    a = a ? a.toLowerCase() : "";
    return this.replace(/<[\/\!\?]?([\w_-]*)[^>]*>/igm, function (f, e) {
...
var m_collect = {
    clearwishfail: "", mdd_token: "", search_login_url: "", wishfail: function (a) {
        ...
        var e = location.href, d = $("#search_" + a), c = d.attr("flag"), b = "add" == c ? "\u6536\u85cf\u5931\u8d25" : "\u53d6\u6d88\u6536\u85cf\u5931\u8d25", h = this;
        clearTimeout(h.clearwishfail);
        $.ajax({
            type: "POST", url: searchUrl + "search_wishlist.php",
            data: {product_id: f, dotype: c, burl: e}, timeout: 5E3, dataType: "json", success: function (a) {
        ...
        if (this.checkLogin() && "none" == $("#customer_load").parent().css("display")) {
            var e =
                "add" == $("#search_" + a).attr("flag") ? "\u6536\u85cf\u4e2d..." : "\u53d6\u6d88\u6536\u85cf\u4e2d ...";
...
$("#curr_page").val(1);
var m_loadMore = {
    p: "", loading: !1, loadC: 0, big_pic_class: "", pageSize: 10, hasNext: !0, type: 1, page: 2, init: function () {
        this.loading = !1;
        this.loadC = 0;
        this.page = 2;
        this.extendFun();
        ...
        this.loading = !0;
        var a = parseInt($("#curr_page").val()) + 1;
        this.page = a;
        var f = JSON.parse(this.p);
        f.page = a;
        var e = f.keyword;
        $.extend(f, $_GET);
        f.keyword = e;
        var d = this;
        this.hasNext && $.ajax({
            type: "GET", url: searchUrl + "search.php", data: f, dataType: "json",
            success: function (c) {
                var b = c.product;
                1 == d.type ? d.cDom1(b) : d.cDom2(b, {big_pic_class: d.big_pic_class});
                $("#curr_page").val(a);
                c.page.pageindex == c.page.total && $(".load").remove();
                d.loading = !1;
                d.loadC++;
                b.length < d.pageSize && (d.hasNext = !1, $(".load").remove())
        ...
        $(function () {
            ...
            $(window).scroll(function () {
                var e = $(".load"), d = $("._pre").css("display");
                if (0 < e.length && "none" !== d) {
                    var d = parseInt(e.height()), e = e.offset().top,
                        c = d + e, d = $(window).scrollTop() + f, c = d - c;
                    (110 > Math.abs(c) || 0 <= c || d >= e) && !a.loading && a.loadMore()
                }
            })
        })
    }, cDom1: function (a) {
        var f = 1, e = "", d = "", c;
        for (c in a) {
            var b = "", h = 1 == a[c].is_customer ? "span_sc_on" : "", k = 1 == a[c].is_customer ? "del" : "add", b = b + "<li><div>", b = b + ('<a href="' + a[c].product_url + '" name="product_item" dd_name="\u5546\u54c1">'), b = b + ('<p class="img"><img class="img_lazy_' + this.loadC + '" data-original="' + a[c].image_url + '" src="' + proxyAssets + 'coreimages/bg_pic.png" alt="' + String.prototype.strip_tags(a[c].product_name +
                    " " + a[c].sub_name) + ' ">');
            0 != a[c].is_overseas && (b += '<span class="overseas"></span>');
            b += "</p>";
            b += '<p class="name">' + a[c].product_name + " " + a[c].sub_name + "</p>";
            a[c].label_recommend && (b += '<span class="rejian">\u63a8\u5e7f</span>');
        ...
        var e = $("#pubo_box_left"), d = $("#pubo_box_right"), c = "undefined" != typeof f.big_pic_class ? f.big_pic_class : "", b;
        for (b in a) {
            var h = e.height(), k = d.height(), l = 1 == a[b].is_customer ? "span_sc_on" : "", m = 1 == a[b].is_customer ? "del" : "add", g = '<div class="pubo_shop_box' + c + '">', g = g + ('<a href="' + a[b].product_url + '"  name="product_item" dd_name="\u5546\u54c1">'), g = g + ('<p class="img"><img class="img_lazy_' + this.loadC + "_" + b + '" id="pro_' + this.page + "_" + a[b].product_id + '" data-original="' + a[b].image_url + '" src="' + proxyAssets + 'coreimages/bg_pic.png" alt="' + String.prototype.strip_tags(a[b].product_name +
                    " " + a[b].sub_name) + '">');
            0 != a[b].is_overseas && (g += '<span class="overseas"></span>');
            g += "</p>";
            list[b].label_recommend && (g += '<span class="rejian">\u63a8\u5e7f</span>');
            ...
            "undefined" != typeof a[b].discount && 0 < a[b].discount && (g += '<span class="zk">' +
                a[b].discount + "\u6298</span>");
