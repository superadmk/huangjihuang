...
var Zepto = function () {
    ...
    var E, j, T, C, S, O, A = [], P = A.concat, N = A.filter, k = A.slice, Z = window.document, D = {}, M = {}, F = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, L = /^\s*<(\w+|!)[^>]*>/, $ = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, _ = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, q = /^(?:body|html)$/i, z = /([A-Z])/g, R = ["val", "css", "html", "text", "data", "width", "height", "offset"], W = ["after", "prepend", "before", "append"], B = Z.createElement("table"), I = Z.createElement("tr"), V = {
        ...
        th: I,
        "*": Z.createElement("div")
    }, H = /complete|loaded|interactive/, X = /^[\w-]*$/, U = {}, J = U.toString, Y = {}, G = Z.createElement("div"), K = {
        tabindex: "tabIndex",
        readonly: "readOnly",
        "for": "htmlFor",
        "class": "className",
    ...
    return Y.matches = function (t, e) {
        ...
        offset: function (t) {
            if (t)return this.each(function (e) {
                var n = T(this), i = g(this, t, e, n.offset()), r = n.offsetParent().offset(), o = {
                    top: i.top - r.top,
                    left: i.left - r.left
                };
